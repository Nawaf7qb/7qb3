document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = {
        math: [
            { text: "ما هو ناتج 5 + 3؟", answer: "8", options: ["5", "8", "10"] },
            { text: "ما هو ناتج 2 * 5؟", answer: "10", options: ["10", "15", "20"] },
            { text: "ما هو ناتج 10 - 4؟", answer: "6", options: ["6", "5", "4"] },
            { text: "ما هو ناتج 15 / 3؟", answer: "5", options: ["5", "3", "10"] },
            { text: "ما هو ناتج 7 + 8؟", answer: "15", options: ["15", "14", "16"] },
            { text: "ما هو ناتج 6 * 7؟", answer: "42", options: ["42", "49", "36"] },
            { text: "ما هو ناتج 20 - 9؟", answer: "11", options: ["11", "10", "12"] },
            { text: "ما هو ناتج 18 / 2؟", answer: "9", options: ["9", "8", "10"] },
            { text: "ما هو ناتج 3 + 4 * 2؟", answer: "11", options: ["11", "14", "10"] },
            { text: "ما هو ناتج (5 + 3) * 2؟", answer: "16", options: ["16", "15", "18"] },
            { text: "ما هو ناتج 10 / 2 + 3؟", answer: "8", options: ["8", "5", "10"] },
            { text: "ما هو ناتج 12 - (4 + 3)?", answer: "5", options: ["5", "4", "6"] },
            { text: "ما هو ناتج 5 * (3 + 2)?", answer: "25", options: ["25", "20", "15"] },
            { text: "ما هو ناتج 20 / (4 + 1)?", answer: "4", options: ["4", "5", "6"] },
            ...
            { text: "ما هو ناتج 9 + 6 / 2؟", answer: "12", options: ["12", "10", "15"] },
            { text: "ما هو ناتج (10 + 2) / 3؟", answer: "4", options: ["4", "5", "6"] },
            { text: "ما هو ناتج 4 * 3 + 2؟", answer: "14", options: ["14", "12", "16"] },
            ...
            { text: "ما هو ناتج س / 4 = 3، فما قيمة س؟", answer: "12", options: ["12", "8", "10"] },
            { text: "ما هو ناتج 2 * س + 3 = 11، فما قيمة س؟", answer: "4", options: ["4", "5", "6"] },
            { text: "ما هو ناتج 5 + س * 2 = 15، فما قيمة س؟", answer: "5", options: ["5", "10", "15"] },
            { text: "ما هو ناتج (س + 3) * 2 = 16، فما قيمة س؟", answer: "5", options: ["5", "4", "6"] },
            { text: "ما هو ناتج 10 / س = 2، فما قيمة س؟", answer: "5", options: ["5", "10", "15"] },
            { text: "ما هو ناتج 3 * س - 2 = 10، فما قيمة س؟", answer: "4", options: ["4", "5", "6"] },
            { text: "ما هو ناتج 2 * (س + 3) = 14، فما قيمة س؟", answer: "4", options: ["4", "5", "6"] }
        ],
        science: [
